...
static class Strings
{
    ...
    public static string LEVEL_TWO_SCENE_NAME = "LevelTwoScene";
    public static string LEVEL_THREE_SCENE_NAME = "LevelThreeScene";
    ...
    public static string TITLE_MUSIC_TAG = "TitleMusic";
}
